...
train.preds.OG <- cbind(train.df, select(original.train, -CDRSB))
test.preds.OG <- cbind(test.df, select(original.test, -CDRSB))
...
if (file.exists("../Model_Results.RData")) {
  cgwtools::resave(models.for.ensemble.OG, model.metrics.OG,
                   ...
                   stacked.ensemble.rf.OG, train.preds.OG, test.preds.OG, 
