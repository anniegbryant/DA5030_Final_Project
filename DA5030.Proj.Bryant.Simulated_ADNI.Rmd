---
title: "DA5030 Final Project -- Simulated ADNI Data"
author: "Annie Bryant"
output: 
  html_document:
    toc: true
...
# use simulate_dataset from fakeR
# stealth.level=2 means each column is simulated independently
# Calculate absolute value since CDRSB > 0
subj.sim <- simulate_dataset(data.to.sim, digits=1, stealth.level=2, ignore=c("RID", "VISCODE", "EXAMDATE")) %>%
  mutate(CDRSB = abs(CDRSB))
